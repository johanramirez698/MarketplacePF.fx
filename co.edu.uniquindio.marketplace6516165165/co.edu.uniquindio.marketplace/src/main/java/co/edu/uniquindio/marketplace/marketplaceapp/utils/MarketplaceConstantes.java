...
public class MarketplaceConstantes {
    ...
    public static final String ERROR=" ¡Algo salio mal! Error procesando la información";
    public static final String MENSAJE="Al parecer hay campos vacios. Por favor, revisa los datos e intenta nuevamente";
}
